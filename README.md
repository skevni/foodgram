...
4. Запустите создание необходимых контейнеров:
...
6. Создайте файл `.env` и заполните его своими данными. Все необходимые переменные перечислены в файле `.env.example`, находящемся в корневой директории проекта.

7. Создаем структуру базы данных, применяя миграции:
