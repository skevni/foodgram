# Generated by Django 6.0 on 2026-01-27 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Уникальный слаг для URL.', max_length=32, unique=True, validators=[recipes.validators.validate_slug], verbose_name='Идентификатор')),
            ],
            options={
                'verbose_name': 'Тег',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Допускаются только буквы, цифры и @/./+/-/_.', max_length=150, unique=True, validators=[recipes.validators.validate_username], verbose_name='Логин')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ('recipe',),
                'abstract': False,
                'constraints': [models.UniqueConstraint(fields=('user', 'recipe'), name='unique_recipes_favorite_user_recipe')],
            },
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name='unique_recipes_shoppingcart_user_recipe'),
        ),
        migrations.AddConstraint(
